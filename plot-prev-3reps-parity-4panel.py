...
model_tag = 'mle'
runtag = "12xsmina"
calx_subp = Path(f'binding/previous-4-microsecond-runs/{resect_tag}/tica-{tica_lag}-msm-{msm_lag}-k-{k}-nframes-{nframes}/extracted_scores/{runtag}/binding-calx-{model_tag}/calx.json')
ignore_calxtypes = {'msm K_D', 'simple avg', 'weighted avg'}
...
filetag = 'prev-3reps-smina-4panels'
